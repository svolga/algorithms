...
Кроме константных переменных дополнительная память не выделяется, значение отсортированных элементов
сохраняется в текущем массиве, поэтому пространственная сложность O(1)
 */
